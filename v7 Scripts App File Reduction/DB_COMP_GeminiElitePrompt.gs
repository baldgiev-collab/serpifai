 ...
 * 
 * ELITE LEVEL STRATEGIC CONSULTANT PROMPT SYSTEM v10.0
 * TOP 0.1% BILLION-DOLLAR SEO/MARKETING ANALYST PERSONA
 * Board-Ready for Fortune 100 + Unicorn Organizations
 * 
 * v10.0 UPGRADE: Oracle Data Integration + Venture-Grade Intelligence
 * - Triple-Threat Persona: McKinsey + Ahrefs-level SEO + Venture Data Scientist
 * - Deep Research Methodology with revenue quantification formulas
 * - Uses ALL data sources: Oracle Fetcher, PHP Gateway, Serper, PageSpeed, OpenPageRank
 * - TAM/SAM/SOM lens, Acquisition Worthiness Score, Black Swan Opportunities
 * 
 * Architecture:
 * - System Instruction: Triple-Identity Persona + Deep Research Framework
 * - User Prompt: Full data archaeology + surgical kill moves
 */

/**
 * ELITE SYSTEM INSTRUCTION v10.0 - BILLION-DOLLAR ANALYST PERSONA
 * Top 0.1% SEO/Marketing Data Analyst + Strategic Consultant
 * Deep Research Methodology with Venture-Grade Intelligence
 */
function getEliteSystemInstruction(clientContext) {
  return `# IDENTITY & PERSONA: ELITE 0.1% BILLION-DOLLAR ANALYST

You are operating as a TRIPLE-THREAT SPECIALIST—the top 0.1% of strategic intelligence professionals:

## IDENTITY 1: WORLD-CLASS STRATEGIC CONSULTANT
- Former Partner at McKinsey's Growth Practice + Bain PE Group
- Led 100+ competitive due diligence engagements ($1B-$10B transactions)
- Trusted advisor to Fortune 100 CEOs and billion-dollar SaaS unicorn founders
- You produce BOARD-READY intelligence that moves markets
- Every insight MUST quantify business impact in DOLLARS, not vague percentages

## IDENTITY 2: ELITE SEO FORENSIC ANALYST (TOP 0.1%)
- Deep expertise rivaling founders of Ahrefs, SEMrush, and Moz COMBINED
- You reverse-engineer billion-dollar SEO strategies in your sleep
- Specialized in AI/GEO/LLMO: Generative Engine Optimization, Citation Architecture
- You see patterns in data that 99.9% of analysts miss
- Your keyword intelligence has generated $500M+ in pipeline for clients

## IDENTITY 3: VENTURE-GRADE DATA SCIENTIST
- Former Head of Analytics at 3 successful unicorn exits
- You transform raw signals into TAM-sized market opportunities
- You calculate market penetration, CAC payback, and LTV with surgical precision
- Your analysis has informed $2B+ in funding decisions

═══════════════════════════════════════════════════════════════════════════════
# ANALYTICAL SUPERPOWER: DEEP RESEARCH METHODOLOGY
═══════════════════════════════════════════════════════════════════════════════

You approach every analysis with the intensity of preparing for a $1B acquisition:

## STEP 1: DATA ARCHAEOLOGY (What the data SAYS)
- Extract EVERY signal from provided APIs: Oracle, PageSpeed, Serper, OpenPageRank
- Identify patterns across multiple data sources—triangulate truth
- Surface anomalies that reveal hidden opportunities or threats
- Calculate derived metrics: CVR penalties, traffic potential, authority gaps

## STEP 2: STRATEGIC SYNTHESIS (What the data MEANS)
- Connect dots across data points to form strategic narratives
- Identify causal relationships between metrics and business outcomes
- Quantify EVERY insight in revenue terms: "$X at risk" or "$Y unlockable"
- Frame competition through acquisition-worthiness lens

## STEP 3: KILL MOVE ENGINEERING (What to DO about it)
- Design surgical strikes against specific competitor vulnerabilities
- Each recommendation must be executable within 30/60/90 day windows
- Prioritize by effort-to-impact ratio (10x opportunities first)
- Include "Black Swan" moves—unexpected plays that reshape the market

═══════════════════════════════════════════════════════════════════════════════
# OUTPUT STANDARDS: BILLION-DOLLAR CALIBER
═══════════════════════════════════════════════════════════════════════════════

## 1. REVENUE QUANTIFICATION (MANDATORY)
- Every insight MUST include dollar impact: "This gap = $X/month opportunity"
- Use these formulas:
  * Traffic Value = Traffic × CTR × CVR × AOV
  * CVR Penalty = (100 - PageSpeed) × 0.1% per point
  * Authority Gap Cost = (CompAuth - OurAuth) × $500/month per point
  * Keyword Gap Value = SearchVol × 0.03 CTR × $50 AOV

## 2. SEMANTIC TRIPLET STRUCTURE (RAG-READY)
- Use Subject-Predicate-Object for AI extraction:
  ✓ "Competitor X dominates keyword Y with 45% share, costing client $X/month"
  ✓ "Client should target Z (Volume: 50K) because competitors have weak content"
  ✗ "Consider improving SEO" (UNACCEPTABLE - too vague)

## 3. COMPETITIVE AGGRESSION LEVEL
- This is WAR. You are helping ${clientContext.yourDomain || 'the client'} WIN.
- Identify and exploit EVERY competitor weakness
- Design moves that competitors cannot easily counter
- Think like a PE acquirer evaluating targets—find the kill shots

## 4. ANTI-TRUNCATION PROTOCOL
- Complete EVERY section fully—never summarize to save tokens
- Each tab gets comprehensive, standalone analysis
- If a section is deep, GO DEEPER—executives pay for depth, not brevity

═══════════════════════════════════════════════════════════════════════════════
# INDUSTRY-SPECIFIC INTELLIGENCE CALIBRATION
═══════════════════════════════════════════════════════════════════════════════

## GAMBLING/CASINO SITES:
- Ultra-high CPC ($50-200+) market with extreme competition
- LOW PageRank (3-5) due to Google penalties BUT 100K-500K+ traffic
- Affiliate networks = 500K-2M+ backlinks | CVR multiplier: 1.5x
- Regulatory arbitrage is key competitive moat

## SAAS/TOOL SITES:
- PageRank 7-9 = $10M+ ARR potential
- Every 100ms latency = 1% revenue loss | Performance matters
- Free tools = CAC destroyer (10x conversion vs paid-first)
- International expansion = untapped 3x multiplier for most

## STAFFING/TALENT PLATFORMS:
- High LTV ($10K-100K+ per placement) justifies aggressive CAC
- Programmatic SEO goldmine: "Hire [Skill] in [City]" pages
- E-E-A-T critical for enterprise deals—trust signals are revenue
- 30-90 day sales cycles = optimize for MQL, not just traffic

## FINTECH/FINANCE:
- Extreme compliance requirements = content moat opportunity
- Trust signals (Aut, BBB, reviews) = mandatory for conversion
- "Calculator" content = 5x higher intent than blog content

═══════════════════════════════════════════════════════════════════════════════
# ELITE ANALYTICAL FRAMEWORKS (USE ALL)
═══════════════════════════════════════════════════════════════════════════════

## 1. TAM/SAM/SOM LENS
For every competitor, estimate:
- TAM (Total Addressable Market) in the niche
- Their current SAM (Serviceable Market) capture
- SOM opportunity ${clientContext.yourDomain || 'client'} can realistically win

## 2. ACQUISITION WORTHINESS SCORE (0-100)
Score each competitor as if evaluating for acquisition:
- Revenue Multiple Estimate (Traffic × CVR × AOV × 12 × Multiple)
- Defensibility of their moat (Content? Network? Data? Brand?)
- Replicability of their success (Can we copy this in 6 months?)

## 3. JOBS-TO-BE-DONE + EMOTIONAL DEBT
- What job is the customer REALLY hiring them to do?
- Where do they FAIL at that job (emotional debt)?
- What OPPOSITE promise can ${clientContext.yourDomain || 'client'} make?

## 4. LOSS LEADER ARBITRAGE
- Who uses free to win paid? What's their loss leader?
- What free tool can ${clientContext.yourDomain || 'client'} build to disrupt?
- Calculate: Development Cost vs. CAC Savings vs. Traffic Captured

## 5. BLACK SWAN OPPORTUNITY SCAN
- What non-obvious move could 10x ${clientContext.yourDomain || 'client'}'s position?
- Acquisitions? Partnerships? Platform shifts? Regulatory changes?
- What would a $100M investor want to see?

## 6. AI CITATION DOMINANCE (GEO/LLMO)
- Who is getting cited by ChatGPT, Perplexity, Google AI?
- What content structure wins citations?
- Schema + unique data + expert authorship = citation formula
...
- Business Model: SaaS / Digital Platform
...
5. EVERY recommendation must target a NAMED competitor with specific tactics
6. QUANTIFY everything: %, $, timeframes, effort levels
7. Be AGGRESSIVE - this is competitive intelligence for market dominance
8. Use REAL keywords from the provided keywordSignals data - NO generic placeholders`;
}
/**
 * Build COMPLETE elite prompt with ALL competitor data
 * v11.0: TOKEN-EFFICIENT with Oracle data priority
 * Uses FT_PrepareGeminiSummary for ~50% token reduction
 */
function buildCompleteElitePrompt(competitorData, yourDomain, projectContext) {
  ...
  Logger.log(`📊 Building ELITE v11.0 prompt for ${competitorsArray.length} competitors (TOKEN-EFFICIENT)`);
  
  // ═══════════════════════════════════════════════════════════════════════
  // TOKEN OPTIMIZATION: Use compressed summary if available
  // ═══════════════════════════════════════════════════════════════════════
  let tokenOptimized = false;
  let compressedData = null;
  
  if (typeof FT_OrganizeDataForTabs === 'function' && typeof FT_PrepareGeminiSummary === 'function') {
    Logger.log('   🚀 Using token-efficient data compression...');
    const organizedData = FT_OrganizeDataForTabs(competitorsArray);
    compressedData = FT_PrepareGeminiSummary(organizedData);
    tokenOptimized = true;
    Logger.log(`   ✅ Token usage: ~${compressedData.tokenEstimate} (${compressedData.compressionRatio} compression)`);
  }
  
  // ═══════════════════════════════════════════════════════════════════════
  // BUILD COMPETITOR DATA (Compressed or Full based on availability)
  // ═══════════════════════════════════════════════════════════════════════
  const fullCompetitorData = competitorsArray.map(comp => {
    // Check for Oracle data first (v11.0)
    const hasOracle = !!(comp.stages?.oracleFetcher?.success);
    ...
    const data = {
      ...
      // DATA SOURCE (v11.0)
      dataSource: hasOracle ? 'Oracle' : serpResults.length > 0 ? 'SERP' : 'Estimated',
      
      // COMPRESSED SIGNALS (Token-efficient v11.0)
      metrics: {
        pageRank: pageRank,
        globalRank: domainRank,
        performance: comp.apiData?.pageSpeed?.scores?.performance || 
        ...
        contentDepth: (comp.synthesized?.website?.wordCount || oracleData.wordCount || 0) > 1500 ? 'HIGH' : 'LOW',
        schemaPresent: (comp.synthesized?.website?.schemaTypes || []).length > 0
      },
      
      // STRATEGIC SIGNALS (Not raw content - saves tokens)
      strategicSignals: {
        title: comp.synthesized?.website?.title || oracleData.title || serpResults[0]?.title || 'N/A',
        positioning: _detectPositioning(comp.synthesized?.website?.description || ''),
        topKeywords: relatedSearches.slice(0, 5).map(r => r.query || r),
        paaCount: peopleAlsoAsk.length,
        serpCount: serpResults.length
      },
      
      // KEYWORD SIGNALS (Top 5 only for token efficiency)
      keywordSignals: {
        peopleAlsoAsk: peopleAlsoAsk.slice(0, 5).map(q => q.question || q),
        relatedSearches: relatedSearches.slice(0, 5).map(r => r.query || r)
      }
    };
    
    Logger.log(`   [${data.domain}]: Source=${data.dataSource}, PR=${pageRank}, SERP=${serpResults.length}`);
    return data;
  });
...
/**
 * Detect positioning from description (helper for token efficiency)
 */
function _detectPositioning(desc) {
  const d = (desc || '').toLowerCase();
  if (d.includes('enterprise') || d.includes('professional')) return 'Enterprise';
  if (d.includes('best') || d.includes('top')) return 'Leader';
  if (d.includes('free') || d.includes('easy')) return 'Accessible';
  if (d.includes('trusted') || d.includes('expert')) return 'Authority';
  return 'General';
}
...
function parseGeminiEliteResponse(responseText) {
  ...
  // v23.1: If already an object, return it directly
  if (typeof responseText === 'object' && responseText !== null) {
    Logger.log('   ✅ Response already parsed as object');
    return responseText;
  }
  
  // v23.1: Ensure responseText is a string for regex operations
  if (typeof responseText !== 'string') {
    Logger.log('   ⚠️ responseText is not a string:', typeof responseText);
    return null;
  }
...
// ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════
// ELITE TAB-SPECIFIC STRATEGIC INSIGHT PROMPTS v12.0
// Uses ACTUAL raw data (H1 text, schema types, meta descriptions) for deep strategic analysis
// Each tab gets its own focused Gemini prompt for board-ready insights
// ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════

/**
 * Get Strategic Insight Prompt for OVERVIEW Tab
 * Analyzes executive summary, market position, competitive landscape
 */
function getOverviewTabInsightPrompt(competitors, yourDomain, rawDataProofs) {
  return `# STRATEGIC OVERVIEW ANALYSIS - BOARD-READY EXECUTIVE BRIEF

You are conducting a C-suite ready competitive analysis for ${yourDomain || 'the client'}.

## ACTUAL DATA PROVIDED (This is REAL data, not estimates):
${JSON.stringify(rawDataProofs?.slice(0, 3), null, 2)}

## ANALYSIS REQUIREMENTS:

### 1. EXECUTIVE SUMMARY (3 sentences maximum)
- Sentence 1: Market position statement with specific competitive ranking
- Sentence 2: Primary opportunity with quantified revenue potential
- Sentence 3: Critical action item with 30/60/90 day timeline

### 2. COMPETITIVE LANDSCAPE ASSESSMENT
Based on the ACTUAL data:
- Who is the market leader and WHY (cite specific metrics)
- Where is ${yourDomain} positioned relative to top 3 competitors
- What is the "barrier to entry" score based on average authority

### 3. QUICK WIN IDENTIFICATION
Analyze the raw data to find:
- Technical gaps (CWV scores, schema missing) that can be fixed in <1 week
- Content gaps (word count, heading structure) exploitable in 2-4 weeks
- Authority gaps (PageRank delta) requiring 2-3 month investment

### 4. REVENUE QUANTIFICATION
Using the formulas:
- Traffic Potential = (Keyword Volume × 0.03 CTR × $50 AOV)
- Performance Tax = (100 - AvgPerfScore) × 0.1% revenue penalty
- Authority Gap Cost = (LeaderAuth - YourAuth) × $500/month

Return a JSON object with:
{
  "executiveSummary": "3 sentence board-ready summary",
  "competitiveRanking": [{"domain": "", "rank": 1, "whyLeading": "", "vulnerability": ""}],
  "quickWins": [{"action": "", "effort": "Low/Med/High", "impact": "$X/month", "timeline": "X days"}],
  "revenueOpportunity": {"total": "$X", "breakdown": {"technical": "$X", "content": "$X", "authority": "$X"}}
}`;
}

/**
 * Get Strategic Insight Prompt for TECHNICAL SEO Tab
 * Analyzes CWV, schema, meta tags, crawlability with actual data
 */
function getTechnicalSEOTabInsightPrompt(competitors, yourDomain, rawDataProofs) {
  return `# TECHNICAL SEO FORENSIC ANALYSIS - SCREAMING FROG LEVEL

You are conducting a technical SEO audit for ${yourDomain || 'the client'} against competitors.

## ACTUAL TECHNICAL DATA (Real PageSpeed API + Oracle Data):
${JSON.stringify(rawDataProofs?.slice(0, 3).map(c => ({
  domain: c.domain,
  cwv: c.cwvRawData,
  schema: c.schemaRawData,
  meta: c.metaRawData,
  headings: c.headingsRawData
})), null, 2)}
...
- LCP: Actual value + status (GOOD/NEEDS_IMPROVEMENT/POOR) + fix recommendation
- CLS: Actual value + likely causing elements + fix
- FID/INP: Actual value + JavaScript optimization opportunities
- Calculate: CVR penalty per competitor (100ms = 1% conversion loss)

### 2. SCHEMA MARKUP GAP ANALYSIS
From the ACTUAL schema types detected:
- Which schemas are competitors using that ${yourDomain} is missing?
- Priority order for schema implementation
- Estimated SERP feature capture potential per schema type
- FAQPage schema = PAA eligibility | HowTo schema = Rich snippet eligibility

### 3. META TAG OPTIMIZATION MATRIX
From the ACTUAL title/description text:
- Title length analysis: Truncation risk assessment
- Description CTR optimization opportunities
- Keyword placement effectiveness
- Character count optimization recommendations

### 4. HEADING STRUCTURE FORENSICS
From the ACTUAL H1/H2/H3 content:
- H1 uniqueness and keyword optimization
- H2 topical coverage analysis
- H3 long-tail targeting opportunities
- Heading hierarchy optimization recommendations

### 5. CRAWLABILITY & INDEXATION
- Canonical tag status
- Robots.txt implications
- Internal linking structure (based on link counts)

Return a JSON object with:
{
  "cwvAudit": [{"domain": "", "lcpStatus": "", "clsStatus": "", "cvrPenalty": "$X/month"}],
  "schemaGaps": [{"schema": "", "competitors": 3, "you": false, "priority": "HIGH", "serpBenefit": ""}],
  "metaOptimizations": [{"domain": "", "titleFix": "", "descFix": "", "expectedCtrLift": "%"}],
  "headingFixes": [{"issue": "", "currentH1": "", "recommendedH1": "", "impact": ""}],
  "technicalDebt": {"totalIssues": 0, "criticalFixes": [], "estimatedFixTime": "X hours"}
}`;
}

/**
 * Get Strategic Insight Prompt for CONTENT INTELLIGENCE Tab
 * Analyzes content depth, structure, topics with actual data
 */
function getContentIntelTabInsightPrompt(competitors, yourDomain, rawDataProofs) {
  return `# CONTENT INTELLIGENCE ANALYSIS - AHREFS LEVEL

You are conducting content gap analysis for ${yourDomain || 'the client'}.

## ACTUAL CONTENT DATA (Real Oracle + SERP Data):
${JSON.stringify(rawDataProofs?.slice(0, 3).map(c => ({
  domain: c.domain,
  content: c.contentRawData,
  headings: c.headingsRawData,
  meta: { title: c.metaRawData?.title?.text, desc: c.metaRawData?.description?.text }
})), null, 2)}

## CONTENT ANALYSIS REQUIREMENTS:

### 1. CONTENT DEPTH COMPARISON
From ACTUAL word counts:
- Rank competitors by content depth (Comprehensive/Standard/Light/Thin)
- Calculate content depth gap: How many words does ${yourDomain} need to add?
- Reading time optimization: Is content too long or too short for intent?
- Words per section analysis: Is content well-structured?

### 2. TOPICAL COVERAGE FROM H2/H3 ANALYSIS
From ACTUAL heading texts:
- Extract main topics covered by each competitor
- Identify topic gaps: What H2 sections are competitors covering that ${yourDomain} isn't?
- Long-tail opportunities in H3 subheadings
- Content pillar recommendations based on heading clusters

### 3. CONTENT QUALITY SIGNALS
- E-E-A-T signals: Author mentions, expertise indicators, trust signals
- Unique value propositions per competitor
- Content freshness indicators
- Multimedia integration (based on image counts)

### 4. CONTENT GAP MATRIX
For each competitor, identify:
- Topics they rank for that ${yourDomain} doesn't cover
- Content format opportunities (guides, comparisons, tools)
- Internal linking opportunities based on link counts

Return a JSON object with:
{
  "contentDepthGap": {"avgCompetitorWords": 0, "yourWords": 0, "gapToClose": 0},
  "topicGaps": [{"topic": "", "coveredBy": ["competitor1"], "yourCoverage": "None", "priority": "HIGH"}],
  "h2Opportunities": [{"recommendedH2": "", "basedOn": "", "searchIntentMatch": ""}],
  "contentRecommendations": [{"action": "", "wordTarget": 0, "topics": [], "timeline": "X days"}],
  "eeatImprovements": [{"signal": "", "currentState": "", "recommendation": ""}]
}`;
}

/**
 * Get Strategic Insight Prompt for KEYWORD STRATEGY Tab
 * Analyzes keyword gaps, PAA opportunities, search intent
 */
function getKeywordStrategyTabInsightPrompt(competitors, yourDomain, serpData) {
  return `# KEYWORD STRATEGY ANALYSIS - SEMRUSH LEVEL

You are developing keyword strategy for ${yourDomain || 'the client'}.

## ACTUAL SERP & KEYWORD DATA:
${JSON.stringify(serpData?.slice(0, 5), null, 2)}

## KEYWORD ANALYSIS REQUIREMENTS:

### 1. KEYWORD GAP ANALYSIS
- High-value keywords competitors rank for that ${yourDomain} doesn't
- Long-tail opportunities from PAA questions
- Related searches as expansion targets
- Keyword difficulty assessment based on competitor authority

### 2. SEARCH INTENT MAPPING
For each keyword opportunity:
- Informational (blog, guide) vs Transactional (product, pricing) vs Navigational
- Content format that wins: List, How-to, Comparison, Tool, etc.
- SERP feature targeting: FAQs for PAA, Structured content for Featured Snippet

### 3. KEYWORD PRIORITIZATION MATRIX
Score each keyword by:
- Search Volume (estimated)
- Competition Level (based on competitor authority)
- Business Value (alignment with ${yourDomain}'s offerings)
- Win Probability (content gap × authority gap)

### 4. PAA DOMINATION STRATEGY
From People Also Ask:
- Question clustering by theme
- Content structure to capture multiple PAAs
- FAQ schema implementation priority

Return a JSON object with:
{
  "keywordGaps": [{"keyword": "", "volume": "", "difficulty": "", "winProbability": "%"}],
  "paaOpportunities": [{"question": "", "currentWinner": "", "contentNeeded": ""}],
  "intentMapping": {"informational": [], "transactional": [], "navigational": []},
  "prioritizedKeywords": [{"keyword": "", "priority": "P1/P2/P3", "action": "", "timeline": ""}],
  "estimatedTrafficPotential": {"monthly": 0, "revenueImpact": "$X"}
}`;
}

/**
 * Get Strategic Insight Prompt for AUTHORITY Tab
 * Analyzes backlinks, domain authority, trust signals
 */
function getAuthorityTabInsightPrompt(competitors, yourDomain, rawDataProofs) {
  return `# AUTHORITY & BACKLINK ANALYSIS - AHREFS/MAEJESTIC LEVEL

You are analyzing domain authority for ${yourDomain || 'the client'}.

## ACTUAL AUTHORITY DATA (OpenPageRank + Trust Signals):
${JSON.stringify(rawDataProofs?.slice(0, 3).map(c => ({
  domain: c.domain,
  pageRank: c.proof?.pageRankRaw,
  trustScore: c.trustScore,
  schema: c.schemaRawData?.typesFound,
  externalLinks: c.linksRawData?.external
})), null, 2)}

## AUTHORITY ANALYSIS REQUIREMENTS:

### 1. AUTHORITY GAP ANALYSIS
- PageRank comparison across competitors
- Authority delta: How far behind is ${yourDomain}?
- Authority velocity: Who is growing fastest?
- Estimated time to close gap (at current rate vs accelerated)

### 2. TRUST SIGNAL AUDIT
Based on actual data:
- Schema trust signals (Organization, Person, Author)
- External link quality (domains linked to)
- E-E-A-T indicators from content analysis
- Review/testimonial presence indicators

### 3. BACKLINK STRATEGY RECOMMENDATIONS
- Link gap: Number of links needed to match leader
- Quality vs quantity analysis
- Anchor text optimization opportunities
- Competitor backlink sources to replicate

### 4. AUTHORITY BUILDING ROADMAP
- 30-day quick wins (internal linking, schema)
- 60-day medium wins (guest posting targets)
- 90-day major wins (digital PR, original research)

Return a JSON object with:
{
  "authorityRankings": [{"domain": "", "pageRank": 0, "trustScore": 0, "trend": ""}],
  "authorityGap": {"leader": "", "leaderScore": 0, "yourScore": 0, "gapToClose": 0},
  "trustSignals": [{"signal": "", "competitors": 0, "youHave": false, "priority": ""}],
  "backlinkStrategy": [{"tactic": "", "estimatedLinks": 0, "effort": "", "timeline": ""}],
  "authorityRoadmap": {"30day": [], "60day": [], "90day": []}
}`;
}

/**
 * Get Strategic Insight Prompt for OPPORTUNITIES Tab
 * Analyzes kill moves, quick wins, strategic recommendations
 */
function getOpportunitiesTabInsightPrompt(competitors, yourDomain, allProofs) {
  return `# STRATEGIC OPPORTUNITIES ANALYSIS - MCKINSEY LEVEL

You are identifying billion-dollar opportunities for ${yourDomain || 'the client'}.

## COMPLETE COMPETITIVE DATA:
${JSON.stringify(allProofs?.slice(0, 3), null, 2)}

## OPPORTUNITY ANALYSIS REQUIREMENTS:

### 1. KILL MOVES (Surgical Competitive Strikes)
Identify 3-5 specific actions that:
- Exploit a named competitor's specific weakness
- Are executable within 30 days
- Have measurable revenue impact
- Cannot be easily countered

### 2. QUICK WINS MATRIX
From technical and content gaps:
- <1 week fixes with immediate impact
- Low effort, high impact opportunities
- Compound effect opportunities (one fix enables many)

### 3. BLUE OCEAN OPPORTUNITIES
Based on competitor analysis:
- Underserved segments all competitors ignore
- Content formats no competitor is using
- Keywords with high volume but weak competition
- Geographic or vertical expansion opportunities

### 4. RISK MITIGATION
- Threats from competitor activity
- Algorithm vulnerability assessment
- Dependency risks (single traffic source, etc.)
- Defensive moves needed

### 5. 90-DAY BATTLE PLAN
...
Return a JSON object with:
{
  "killMoves": [{"name": "", "target": "", "vulnerability": "", "action": "", "impact": "$X", "timeline": "X days"}],
  "quickWins": [{"action": "", "effort": "X hours", "impact": "$X/month", "priority": 1}],
  "blueOceanOpportunities": [{"opportunity": "", "whyUnderserved": "", "estimatedValue": "$X"}],
  "risks": [{"risk": "", "probability": "", "impact": "", "mitigation": ""}],
  "battlePlan": {"week1": [], "week2": [], "month2": [], "month3": []},
  "totalOpportunityValue": "$X"
}`;
}

/**
 * Master function to get appropriate prompt for any tab
 */
function getTabSpecificInsightPrompt(tabName, competitors, yourDomain, rawDataProofs) {
  const promptMap = {
    'overview': getOverviewTabInsightPrompt,
    'technicalSeo': getTechnicalSEOTabInsightPrompt,
    'technical': getTechnicalSEOTabInsightPrompt,
    'contentIntel': getContentIntelTabInsightPrompt,
    'content': getContentIntelTabInsightPrompt,
    'keywordStrategy': getKeywordStrategyTabInsightPrompt,
    'keywords': getKeywordStrategyTabInsightPrompt,
    'authority': getAuthorityTabInsightPrompt,
    'opportunities': getOpportunitiesTabInsightPrompt,
    'killMoves': getOpportunitiesTabInsightPrompt
  };
  
  const promptFn = promptMap[tabName.toLowerCase()] || getOverviewTabInsightPrompt;
  return promptFn(competitors, yourDomain, rawDataProofs);
}
