...
function loadProject(name) {
  try {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // LOAD COMPETITOR ANALYSIS DATA (NEW)
    // Automatically loads the last competitor analysis tied to this project
    // ═══════════════════════════════════════════════════════════════════════════
    let competitorAnalysis = null;
    try {
      Logger.log('📊 Loading competitor analysis for project...');
      
      // Try loadCompetitorAnalysis from UI_ProjectLoader.gs
      if (typeof loadCompetitorAnalysis === 'function') {
        ...
        // Fallback: Try loadCompetitorResults from DB_CompetitorStorage.gs
